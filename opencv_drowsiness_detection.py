...
def create_interface():
    ...
    try:
        ...
        logo_image = Image.open("ddu.jpg")  # Ensure the path is correct
        logo_image = logo_image.resize((175, 175))  # Resize the logo
    ...
    header_label = tk.Label(top_frame, text="Safe Drive AI", font=("Arial", 24, "bold"), fg="black", bg="#f4f4f9")
